...
common.simpleStart({
    ...
    overtime = 1, --超时时间，/分钟
    endMapIds = {37410}, -- 结束一轮的地图id 默认为最后一张图，设置则以此值为准，没有可以不设置
    initSettings = {  -- 脚本初始化时的配置参数 可以不设置
        tobot_fastladder = 0, -- 取消快速爬梯，防止大桥下楼梯不稳定
    },

    -- 是否最终图换掉落装，默认为不换，需要换设置此开关，设置后，换完掉落装到下个图会自动换攻击装
    ...
    scripts = {
       ...
       -- 冰淇淋8
       "",
       -- 冰淇淋9
       "",
       -- 冰淇淋10
    ...
    onScriptRound = function () -- 副本每次切换地图回调
        if (getmapid() == 123) then
            common.doPetSkill() -- 使用宠物技能
        end
    end
})