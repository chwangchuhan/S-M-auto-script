...
common.simpleStart({
    ...
    scripts = {
       ...
       -- 入口
       "",
       -- 训练地1
       ...
       -- 陷阱1
       "",
       -- 修炼2
	   ...
	   -- 修炼3
	   "",
	   -- 战场
	   ...
	   -- 奖励
	   "BDF8C8EBB4ABCBCDC3C52CD7F326D3D2CAB12C3538302C313430372CB2BBB1E42C0D0ABDF8C8EBB4ABCBCDC3C52CD7F326D3D2CAB12C3630302C313430372CB2BBB1E42C0D0ABDF8C8EBB4ABCBCDC3C52CD7F326D3D2CAB12C3632302C313430372CB2BBB1E42C",
	   -- 副本13
	   "",
	   -- 副本14
	   "",
    ...
    onScriptRound = function () -- 副本每次切换地图回调
		...
		if (getmapid() == 37905) then
			...
			repeat
				...
				if gety()==431 and getx()<4500 and getx()>3750 and mobY1==431 then
					speak("躲避闪电1")
				...
				if gety()==431 and getx()<4500 and getx()>3750 and mobY2==431 then
					speak("躲避闪电1")
					ini_change("tobot_hit_range_right",3680)
					ini_change("tobot_hit_range_left",3750)
					ini_change("ban_hit_mob",1)
				...
				if gety()==431 and mobY2 ~=431 and mobY1~=431  then 
					speak("一层已清")
				...
				if gety()==943 and getx()<4500 and getx()>3750 and mobY1==943 then
					speak("躲避闪电2")
					ini_change("tobot_hit_range_right",3680)
					ini_change("tobot_hit_range_left",3750)
					ini_change("ban_hit_mob",1)
				...
				if gety()==943 and getx()<4500 and getx()>3750 and mobY2==943 then
					speak("躲避闪电2")
					ini_change("tobot_hit_range_right",3680)
					ini_change("tobot_hit_range_left",3750)
					ini_change("ban_hit_mob",1)
				...
				if gety()==943 and mobY2~=943 and mobY1~=943 and mobY3~=943 then 
					speak("二层左边已清")
					ini_change("tobot_hit_range_right",32)
					ini_change("tobot_hit_range_left",99999)
					labelkuang=1
				end
				if gety()==943 and labelkuang==1 and mobx4~=0 then --采集
					bot_stop()
					speak("采集魔心")
					useskill(43501018,1)
				...
				if (getmapid() == 37906) then
					script_txt_loaddata("",0)
				end
		...
		if (getmapid() == 37907) then
			...
			repeat
				...
				if gety()==543 and getx()>4700 and getx()<=5600 then
					speak("禁止攻击")
					ini_change("ban_hit_mob",1)
					sleep(200)
					bot_start()
