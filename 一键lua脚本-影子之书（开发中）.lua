...
local yaoshiScripts = {
    ...
    -- 目录进h
    '',
    -- 刷钥匙h门
...
common.simpleStart({
    ...
    overtime = 30, --超时时间，/分钟
    -- 地图名称列表，需和mapIds一一对应
    mapIds = {20004, 20000, 58600.0, 58603, 58601, 58602, 58608, 58601, 58604, 58612, 58611, 58610, 58605, 58613, 58614},
    -- 脚本名称列表，需和mapIds一一对应
    -- 支持16进制hex编码脚本
    ...
    onScriptRound = function () -- 副本每次切换地图回调
        ...
        if (isFindYaoshi and not isGoBoss and mapIndex ~= 0) then
            ...
            -- 钥匙7张图跑完
            if (mapIndex > 7) then
                local yaoshiIndex = findYaoshiIndex(yaoshiList)
