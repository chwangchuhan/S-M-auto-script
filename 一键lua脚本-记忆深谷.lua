...
local function isitem()
	if item_if("遗忘之城传送石")~=0 then --有没有天使之泪--
		return true
	end
	printgame(0,255,0,"没有[遗忘之城传送石],此Lua结束")
	speak("没有[遗忘之城传送石],此Lua结束")
	return false
end
...
common.simpleStart({
    ...
    scripts = {
       ...
       "",
       -- 副本进门
       "",
       -- 1
