...
local killMob = function(mob, killId)
    ...
    if (mobId > 0) then
        ...
        bot_stop()
		--ini_change("tobot_hit_range_right",abs(mobX)-25)
		--ini_change("tobot_hit_range_left",abs(mobX)+25)
...
common.simpleStart({
    ...
    scripts = {
        ...
        -- √Œª√Õº Èπ›4
        '',
        -- √Œª√Õº Èπ›5
    ...
    onScriptWhileCallback = function ()
        ...
        if (mapId == 33006) then
            ...
            if (x >= 1120 and common.checkMob({"¥©ÀÛπ‚ ¯"})) then
                ...
                while (common.checkMob({"¥©ÀÛπ‚ ¯"})) do
                    sleep(2)
                    if (common.checkMobIsAside('¥©ÀÛπ‚ ¯', 20, 100)) then
                        bot_stop()
                        sleep(3000)
                        bot_start()
                        sleep(3000)
